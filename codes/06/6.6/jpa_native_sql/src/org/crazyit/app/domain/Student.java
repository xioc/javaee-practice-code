...
@SqlResultSetMapping(name="stu_mapping",
	entities={
		@EntityResult(entityClass=org.crazyit.app.domain.Student.class
			, fields={
			@FieldResult(name="studentNumber", column="student_id"),
			@FieldResult(name="name", column="name")}),
		@EntityResult(entityClass=org.crazyit.app.domain.Enrolment.class)
	},
	columns={
